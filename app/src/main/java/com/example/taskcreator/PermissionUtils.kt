    ...
    class PermissionDeniedDialog : DialogFragment() {
        ...
        override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
            ...
            return AlertDialog.Builder(activity)
                .setMessage("This sample requires location permission to enable")
        ...
        override fun onDismiss(dialog: DialogInterface) {
            ...
            if (finishActivity) {
                Toast.makeText(
                    activity, "Location permission is required",
                    Toast.LENGTH_SHORT
                ).show()
                activity?.finish()
            }
    ...
    class RationaleDialog : DialogFragment() {
        ...
        override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
            ...
            finishActivity =
                arguments?.getBoolean(ARGUMENT_FINISH_ACTIVITY) ?: false
            return AlertDialog.Builder(activity)
                .setMessage("Access to the location service is required")
